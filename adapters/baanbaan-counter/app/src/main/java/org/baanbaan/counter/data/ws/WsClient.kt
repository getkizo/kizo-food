package org.baanbaan.counter.data.ws
...
import org.baanbaan.counter.data.model.CounterStatusMessage
...
import org.baanbaan.counter.data.model.RawMessage
import org.baanbaan.counter.di.ApplicationScope
...
class WsClient @Inject constructor(
    ...
    private val listener = object : WebSocketListener() {
        override fun onOpen(webSocket: WebSocket, response: Response) {
            Log.i(TAG, "Connected to BaanBaan")
            reconnectAttempt = 0
