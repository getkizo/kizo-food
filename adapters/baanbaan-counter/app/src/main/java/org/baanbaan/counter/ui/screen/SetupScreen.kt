...
@Composable
fun SetupScreen(
    viewModel: org.baanbaan.counter.ui.viewmodel.MainViewModel,
    ...
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Row(
            ...
            // Left column: BaanBaan connection
            Card(
                modifier = Modifier
                    .weight(1f)
                    .fillMaxSize(),
                ...
                Column(
                    ...
                    Text("BaanBaan Server", style = MaterialTheme.typography.titleLarge)
                    Text(
                        "Enter the WebSocket URL of your BaanBaan server.",
                    ...
                    Text(
                        "Finix credentials and restaurant name are provisioned automatically by BaanBaan on first connection.",
                        style = MaterialTheme.typography.bodyLarge,
